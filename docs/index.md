...
Welcome to my personal documentation. This is a living reference I use while
working with Kotlin and Android — notes, snippets, gotchas, and links I don't
want to have to re-search every time.

Use the search bar (top of the page) or the navigation tabs above to jump to
a topic.
